...
if __name__ == '__main__':
    ...
    # Vary packet count
    generate(128, 20_000, 2)
    generate(128, 40_000, 2)
    generate(128, 60_000, 2)
    generate(128, 80_000, 2)
    generate(128, 100_000, 2)
    generate(128, 120_000, 2)
    generate(128, 140_000, 2)
    generate(128, 160_000, 2)
    generate(128, 180_000, 2)
    generate(128, 200_000, 2)

    # Vary packet length
    generate(128, 100_000, 2)
    generate(256, 100_000, 2)
    ...
    generate(128, 100_000, 5)
    generate(128, 100_000, 6)
    generate(128, 100_000, 7)
    generate(128, 100_000, 8)
    generate(128, 100_000, 9)
    generate(128, 100_000, 10)
